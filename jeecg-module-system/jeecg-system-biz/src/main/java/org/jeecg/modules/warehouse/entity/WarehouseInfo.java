...
@ApiModel(value="tb_warehouse_info对象", description="仓库表")
public class WarehouseInfo implements Serializable {
	...
	/**仓库所在地*/
	@Excel(name = "仓库所在地", width = 15)
    @ApiModelProperty(value = "仓库所在地")
    private java.lang.String address;
	/**仓库管理员*/
	@Excel(name = "仓库管理员", width = 15)
    @ApiModelProperty(value = "仓库管理员")
    private java.lang.String warehouseOwner;
	/**管理员手机号*/
	@Excel(name = "管理员手机号", width = 15)
    @ApiModelProperty(value = "管理员手机号")
    private java.lang.String phone;
	/**仓库管理员账号id*/
	@Excel(name = "仓库管理员账号id", width = 15, dictTable = "sys_user", dicText = "realname", dicCode = "username")
	@Dict(dictTable = "sys_user", dicText = "realname", dicCode = "username")
    @ApiModelProperty(value = "仓库管理员账号id")
