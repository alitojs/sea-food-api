...
import org.jeecg.modules.product.vo.ProductInfoPage;
...
public class ProductInfoController {
	...
	public Result<List<ProductSpecification>> queryProductSpecificationListByMainId(@RequestParam(name="id",required=true) String id) {
		List<ProductSpecification> productSpecificationList = productSpecificationService.selectByMainId(id);
		return Result.OK(productSpecificationList);
	}
